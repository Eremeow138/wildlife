...
let leftButton = document.querySelector('.slider__button_left');
let rightButton = document.querySelector('.slider__button_right');
...
let sliderContainer = document.querySelector('.slider__slides');

let isDrag = false;
let startX = 0;

//для работы перелистывания мышью - раскомментировать код внизу
